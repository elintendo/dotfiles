...
pacman -S --needed autorandr exa qbittorrent btop flameshot brightnessctl xorg-xclipboard
echo "*"
...
echo "*"
echo "sound support"
pacman -Su --needed pulseaudio pulseaudio-alsa pavucontrol
echo "*"
...
ln -sf $DOTS_DIR/x11/Xresources $USER_DIR/.Xresources
ln -sf $DOTS_DIR/x11/xprofile $USER_DIR/.xprofile
